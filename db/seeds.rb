...
dhh_p.profile_image.attach(io: File.open(File.expand_path(__FILE__).split('/app')[0] + '/app/development_data/dhh.jpg'), filename: 'dhh.jpg')
...
chris_p.profile_image.attach(io: File.open(File.expand_path(__FILE__).split('/app')[0] + '/app/development_data/chris.jpeg'), filename: 'chris.jpeg')
...
ray_p.profile_image.attach(io: File.open(File.expand_path(__FILE__).split('/app')[0] + '/app/development_data/ray.jpg'), filename: 'ray.jpg')
...
kevin_p.profile_image.attach(io: File.open(File.expand_path(__FILE__).split('/app')[0] + '/app/development_data/kevin.jpg'), filename: 'kevin.jpg')
